...
const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 Shigoto Q —
      <Link to="https://twitter.com/shigoto" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@shigoto</Link>
    </p>
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      ...
      <Link to="https://linkedin.com" className="ml-3 text-gray-500">
