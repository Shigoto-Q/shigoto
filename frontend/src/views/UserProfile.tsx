    ...
    <>
      ...
      <div>
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="mt-5 text-lg font-medium leading-6 text-gray-900">Github</h3>
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-gray-500">Get notified when a task finishes.</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <div className="flex items-center h-5">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-gray-500">Get notified when a task succeds.</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <div className="flex items-center h-5">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-gray-500">Get notified when a task fails.</p>
                        </div>
                      </div>
                    </div>
                  </fieldset>
